...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 131400; //525600 min per year / 4 min per block
        consensus.BIP34Height = 1;
	//TODOGUANG - new block1 hash
	...
	//TODOGUANG Genesis + Hash
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 10 * COIN);
	...
	//TODOGUANG PREFIXES - these will be different, as our addresses are BLAKE2224(SHA256(x))
